...
export default function HomePage() {
  ...
  const handleCreateMeeting = () => {
    ...
    setTimeout(() => {
      ...
      setIsCreating(false);
      // Here you would redirect to the new meeting room
    }, 1500);
  };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                ...
                <p className="text-xl text-muted-foreground animate-in fade-in slide-in-from-left-4 duration-700 delay-100 fill-mode-both">
                  High-quality video meetings for teams and individuals. Join or
            ...
            <Tabs defaultValue="upcoming" className="w-full">
              <div className="flex justify-between items-center mb-6">
                ...
                <TabsList>
                  ...
                  <TabsTrigger value="recent" className={"cursor-pointer"}>Recent</TabsTrigger>
                </TabsList>
              </div>
              ...
              <TabsContent value="upcoming" className="mt-0">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <Card className="border-dashed flex flex-col items-center justify-center p-6 h-full cursor-pointer">
                    ...
                    <Button variant="outline" className={"cursor-pointer"}>Schedule</Button>
                  </Card>
                </div>
              </TabsContent>
