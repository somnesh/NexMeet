...
export default function PreJoinPage() {
  ...
  useEffect(() => {
    if (!selectedDevices.audioInput || errors.microphone) return;
  ...
  // Join meeting
  const joinMeeting = () => {
    // In a real app, this would connect to your meeting service
    alert(`Joining meeting as ${userName || "Anonymous"}`);
  };
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-10 px-6 py-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="h-8 w-8 rounded-full bg-primary flex items-center justify-center">
            <Video className="h-4 w-4 text-primary-foreground" />
          </div>
          <h1 className="text-xl font-semibold">MeetSync</h1>
        </div>
        <div className="text-sm text-gray-500 dark:text-gray-400 flex items-center">
          <span className="hidden md:inline mr-2">Meeting Code:</span>
      ...
      <main className="min-h-screen pt-16 ">
        <div>
          ...
          >
            ...
            <div
              className={`${
                isMobile ? "h-[40vh]" : "w-3/5 h-fit"
              } relative mx-2 my-3 flex items-center justify-center bg-gray-100 dark:bg-gray-900`}
            >
              {isCameraOn && !errors.camera ? (
                ...
                <div className="flex flex-col h-full items-center justify-center text-gray-500 dark:text-gray-400">
                  <div className="h-full w-full rounded-full bg-gray-200 dark:bg-gray-800 flex items-center justify-center mb-4">
                    {errors.camera ? (
              ...
              {/* User name overlay */}
              {userName && isCameraOn && !errors.camera && (
              ...
              {!isMicMuted && !errors.microphone && (
                <div className="absolute bottom-6 right-6 flex items-end gap-1 px-4 py-3 bg-gray-900/60 dark:bg-black/60 backdrop-blur-sm rounded-lg">
              ...
              <div className="absolute bottom-0 left-0 right-0 flex justify-center gap-4 p-6 bg-gradient-to-t from-gray-900/80 dark:from-black/80 to-transparent">
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        className={`rounded-full h-14 w-14 transition-all duration-300 ${
                          errors.camera
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button
                      ...
                      size="icon"
                      aria-label="Settings"
                      className="rounded-full h-14 w-14 bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 border-0"
                    >
            ...
            <div
              className={`
              ${isMobile ? "h-[60vh]" : "w-2/5 h-screen"} 
              ...
              <div className="space-y-8 max-w-md mx-auto w-full">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="flex h-10 w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-950"
                  />
                </div>
                ...
                <div className="flex flex-wrap gap-4 justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        {errors.speaker ? "Not available" : `${speakerVolume}%`}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {!errors.speaker && (
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <audio
                      ref={audioTestRef}
                      src="/placeholder.svg" // In a real app, use an actual test sound
                      className="hidden"
                    />
                  </div>
                )}
                ...
                <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-800">
                  <Button
                    onClick={joinMeeting}
                    className="w-full py-6 rounded-xl bg-primary hover:bg-primary/90 text-white font-medium text-base transition-all duration-300"
                  >
                    Join Meeting
                  </Button>
                </div>
      ...
      {/* Footer */}
      {/* <footer className="fixed bottom-0 left-0 right-0 z-10 px-6 py-3 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-t border-gray-200 dark:border-gray-800 flex items-center justify-between text-gray-500 dark:text-gray-400 text-sm">
        <div>© 2025 MeetSync</div>
